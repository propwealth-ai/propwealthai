...
import { DollarSign, ArrowUpRight, ArrowDownRight, RefreshCw, CreditCard } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className={cn("flex items-center justify-between", isRTL && "flex-row-reverse")}>
        <h3 className="text-lg font-semibold text-foreground">{t('admin.recentTransactions')}</h3>
